    ...
    productos.forEach((producto) => {
        ...
        <div class="content">
            ...
            <div class="back-content">
                ...
                <p class="title">
                <strong>${producto.CategoriaID}</strong>
                </p>
            </div>
            </div>
            <div class="front">
            ...
            <div class="front-content">
                <small class="badge">${producto.CantidadPorUnidad}</small>
                <div class="description">
                <div class="title">
                <button class="edit-button update" id="${producto._id}" data-bs-toggle="modal" data-bs-target="#modalUpdate">
                ...
                <button class="delete-button eliminar" id="${producto._id}">
